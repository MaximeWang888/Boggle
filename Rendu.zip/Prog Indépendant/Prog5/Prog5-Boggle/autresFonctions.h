 ...
 * @param [in, out] ref_list la liste de mots que nous ajouterons à "listOfLists"
*/
void ajouterListe(List& ref_list);


/**
 * @brief Affiche une liste de mots dans la grande liste "listOfLists"
 * @param ref_list la liste de mots que nous afficherons
*/
