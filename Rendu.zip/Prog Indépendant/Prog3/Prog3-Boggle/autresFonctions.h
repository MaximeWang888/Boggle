 ...
 * @param [in] saveWord La liste de mots auquel on va comparer avec le mot de la seconde liste.
 * @param [in] saveWord1 La seconde liste de mots auquel on va le comparer avec les mots de la première liste.
 ...
 * @param [in] saveWord La liste des mots de la première liste de mots.
 * @param [in] saveWord1 La liste des mots de la deuxième liste de mots.
